error id: file://<WORKSPACE>/src/main/java/com/sixdee/text2rule/factory/LLMClientFactory.java:com/sixdee/text2rule/client/ResilientChatLanguageModel#
file://<WORKSPACE>/src/main/java/com/sixdee/text2rule/factory/LLMClientFactory.java
empty definition using pc, found symbol in pc: com/sixdee/text2rule/client/ResilientChatLanguageModel#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 4691
uri: file://<WORKSPACE>/src/main/java/com/sixdee/text2rule/factory/LLMClientFactory.java
text:
```scala
...
public class LLMClientFactory {
    ...
    private static ChatLanguageModel createOpenAIModel(ConfigurationManager config) {
        ...
        try {
            ...
            // Wrap with resilient client to handle rate limits
            return new com.sixdee.text2rule.client.Res@@ilientChatLanguageModel(model, 3);
        } catch (Exception e) {
    ...
    private static ChatLanguageModel createGroqModel(ConfigurationManager config) {
        ...
        try {
            ...
            // Wrap with resilient client to handle rate limits
            return new com.sixdee.text2rule.client.ResilientChatLanguageModel(model, 3);
        } catch (Exception e) {
