error id: file://<WORKSPACE>/src/main/java/com/sixdee/text2rule/tool/JsonExtractorTool.java:_empty_/ObjectMapper#
file://<WORKSPACE>/src/main/java/com/sixdee/text2rule/tool/JsonExtractorTool.java
...
offset: 558
uri: file://<WORKSPACE>/src/main/java/com/sixdee/text2rule/tool/JsonExtractorTool.java
text:
```scala
...
public class JsonExtractorTool {
    ...
    private static final ObjectM@@apper objectMapper = new ObjectMapper()
