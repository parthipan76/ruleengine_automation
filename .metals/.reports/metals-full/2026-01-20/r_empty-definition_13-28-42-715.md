error id: file://<WORKSPACE>/src/main/java/com/sixdee/text2rule/config/SupabaseService.java:_empty_/ConfigurationManager#getSupabaseTimeoutSeconds#
file://<WORKSPACE>/src/main/java/com/sixdee/text2rule/config/SupabaseService.java
empty definition using pc, found symbol in pc: _empty_/ConfigurationManager#getSupabaseTimeoutSeconds#
...
public class SupabaseService {
    ...
    public SupabaseService() {
        ...
        this.timeoutSeconds = config.getSu@@pabaseTimeoutSeconds();
