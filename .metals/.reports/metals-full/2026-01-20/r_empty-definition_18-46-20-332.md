error id: file://<WORKSPACE>/src/main/java/com/sixdee/text2rule/Main.java:com/sixdee/text2rule/observability/IntegrationFactory#startWorkerThread#
file://<WORKSPACE>/src/main/java/com/sixdee/text2rule/Main.java
empty definition using pc, found symbol in pc: com/sixdee/text2rule/observability/IntegrationFactory#startWorkerThread#
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String obsUrl = config.getObservabilityUrl();
            String obsKey = config.getObservabilityApiKey();

            if (obsUrl != null && !obsUrl.isEmpty()) {
                com.sixdee.text2rule.observability.IntegrationFactory.startW@@orkerThread(obsUrl, obsKey);
                logger.info("Observability worker started [endpoint={}]", obsUrl);
            } else {
                logger.warn("Observability URL not configured, worker not started.");
            }
